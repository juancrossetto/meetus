...
interface DailyQuestionConfigPageProps {}

const DailyQuestionConfigPage: FC<DailyQuestionConfigPageProps> = () => {
    ...
    <Layout>
      <Container maxW="7xl">
        <VStack flexDirection="column" alignItems="center" justifyContent="center" spacing={10} position="relative">
          <Heading>Configuración de Pregunta Diaria</Heading>
          {dailyQuestion && (
...
export default DailyQuestionConfigPage;
